		...
		<ul>
			...
			<div className="flex">
				<div className="flex a-c">
					<li>
						<a
							href="https://github.com/Devzstudio/SQL-to-Prisma-Schema-Generator"
							target="_BLANK"
							rel="noreferrer,noopener"
						>
							<img src="https://img.shields.io/github/stars/devzstudio/SQL-to-Prisma-Schema-Generator?style=social" />
						</a>
					</li>
				...
				<li className="border-left pl-2">
					<a
						target="_BLANK"
						href="https://codekeep.io?ref=sql-to-prisma"
						rel="noreferrer noopener"
						className="spons"
					>
